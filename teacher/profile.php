...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">When can you join ?</label><input type="date" name="joiningdate" id="joiningdate" value="<?php  echo $row->JoiningDate;?>" class="form-control" required="true"></div>
</div>
</div>
</div>
...
<select type="text" name="qualifications" id="qualifications" value="" class="form-control" required="true" >
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Department</label><select type="text" name="tsubjects" id="tsubjects" value="" class="form-control" required="true">
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Description (optional)</label><textarea type="text" name="description" id="description" class="form-control" rows="3" cols="12"><?php  echo $row->description;?></textarea></div>
</div>
</div>
